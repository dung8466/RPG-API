...
public class CharaterController : ControllerBase
{
    ...
    [HttpPost("Skill")]
    public async Task<ActionResult<ServiceResponse<GetCharaterDto>>> AddCharaterSkill(AddCharaterSkillDto newCharaterSkill)
    {
        return Ok(await charaterService.AddCharaterSkill(newCharaterSkill));
    }
}